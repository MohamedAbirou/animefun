...
const TermsOfServicePage = () => {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <SEOHead
        title="Terms of Service — AnimeFun"
        description="Read AnimeFun's terms of service governing your use of our anime wallpapers, quizzes, and games platform."
      ...
      <div className="prose dark:prose-invert max-w-none">
        <section className="mb-8">
          ...
          <p>
            By accessing and using AnimeFun, you accept and agree to be bound by
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            materials (wallpapers, games) on AnimeFun for personal,
            non-commercial transitory viewing only.
          </p>
          <p className="mt-4">
            This license shall automatically terminate if you violate any of
            these restrictions and may be terminated by AnimeFun at any time.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            The materials on AnimeFun are provided on an 'as is' basis. AnimeFun
        ...
        <section className="mb-8">
          ...
          <p>
            In no event shall AnimeFun or its suppliers be liable for any
            damages (including, without limitation, damages for loss of data or
            profit, or due to business interruption) arising out of the use or
            inability to use the materials on AnimeFun.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            AnimeFun may revise these terms of service at any time without
